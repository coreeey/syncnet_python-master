...
class SyncNetInstance(torch.nn.Module):
    ...
    def evaluate(self, opt, videofile):
        ...
        # video = cv2.VideoCapture(os.path.join(opt.tmp_dir, opt.reference + '.avi'))
        video = cv2.VideoCapture(os.path.join('data', 'example' + '.avi'))
